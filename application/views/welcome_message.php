                    ...
                    <?php foreach ($data as $key => $product) { ?>
                        <div class="col-4 col-sm-12 col-lg-4">
                            <div class="card bg-white" style="width: 18rem;">
                                <img src="<?php echo base_url('assets/images-products/'. $product->image ) ?>" class="card-img-top text-center">
                                <div class="card-body text-center mt-2">
                                    ...
                                    <button
                                        ...
                                        @click="getProductIdentier(<?php echo $product->id_product ?>)"                                    
                                    >
                                ...
                                <div class="block block-themed block-transparent mb-0">
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 text-center alert alert-info" v-if="productAdded">
